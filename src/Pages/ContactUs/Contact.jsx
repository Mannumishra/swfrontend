...
const Contact = () => {
  ...
  const postData = async (e) => {
    e.preventDefault()
    try {
      const res = await axios.post("https://swhealthcare.digiindiasolutions.com/api/send-enquery", data)
      if (res.status === 200) {
        Swal.fire({
          title: 'Success!',
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 mt-4">
              <h1 className="mb-4 text-center" style={{ color: "#6E84D0" }}>Contact Information</h1>
              <div className="row">
                {/* Telephone */}
                ...
                <div className="col-12 mb-4">
                  <div className="contact-detail-card">
                    ...
                    NO. 50 , Pocket I, FACOTORY, DSIIDC Industrial Area, Sector 4, Bawana, Delhi, 110039
                    </address>
                  </div>
                </div>
                ...
                <div className="col-12 mb-4">
                  <div className="contact-detail-card">
                    ...
                    <a
                      href="mailto:swhealthcare@gamil.com"
                      className="contact-link"
                    >
                      swhealthcare@gamil.com
                    </a>
                  </div>
                </div>
            ...
            <div className="col-md-6">
              <div className="contactForm">
                <h1 className="text-center" style={{ color: "#6E84D0" }}>Contact Form</h1>
      ...
      <section className="maps">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3496.2236557566207!2d77.07540287376085!3d28.802408176349253!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390da96f65053ca1%3A0x3b0ee88a8d1de5ac!2sSW%20HEALTH%20CARE!5e0!3m2!1sen!2sin!4v1735810487058!5m2!1sen!2sin" width="100%" height="450" style={{border:0 }}allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </section>
    </>
  );
};
