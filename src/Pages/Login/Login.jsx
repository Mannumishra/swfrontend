            ...
            <div className="col-md-6 register_responsive text-center">
              <div className="signup">
                ...
                <p className="register-info">
                  By creating an account, you will enjoy easy access to our premium health products, track your orders, and receive the latest updates on new healthcare solutions.
                </p>
