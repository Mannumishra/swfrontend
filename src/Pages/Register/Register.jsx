    ...
    try {
      if (data.password === cPass) {
        const res = await axios.post(
          "https://swhealthcare.digiindiasolutions.com/api/signup",
          data
        );
        if (res.status === 201) {
          Swal.fire({
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 register_responsive text-center">
              <div className="signup">
                <h3 className="new-customer">Login to Your SW Healthcare Account</h3>
                <hr />
                <p className="register-info">
                  If you already have an account with SW Healthcare, please login to access our premium healthcare products and manage your orders.
                </p>
